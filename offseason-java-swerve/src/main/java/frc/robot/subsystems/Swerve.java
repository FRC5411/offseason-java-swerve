...
public class Swerve extends SubsystemBase {
  ...
  public void periodic() {
    ...
    Telemetry.setValue("drivetrain/Modules/FL/Drive/Temp", FL_Drive.getTemperature());
    Telemetry.setValue("drivetrain/Modules/FR/Drive/Temp", FR_Drive.getTemperature());
    Telemetry.setValue("drivetrain/Modules/BL/Drive/Temp", BL_Drive.getTemperature());
    Telemetry.setValue("drivetrain/Modules/BR/Drive/Temp", BR_Drive.getTemperature());
    Telemetry.setValue("drivetrain/Modules/FL/Azimuth/Temp", FL_Azimuth.getTemperature());
    Telemetry.setValue("drivetrain/Modules/FR/Azimuth/Temp", FR_Azimuth.getTemperature());
    Telemetry.setValue("drivetrain/Modules/BL/Azimuth/Temp", BL_Azimuth.getTemperature());
    Telemetry.setValue("drivetrain/Modules/BR/Azimuth/Temp", BR_Azimuth.getTemperature());
