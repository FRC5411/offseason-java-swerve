...
public class Swerve extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // dashboard data
    Telemetry.setValue("drivetrain/FL/Azimuth/Target", FL_Target);
    Telemetry.setValue("drivetrain/FR/Azimuth/Target", FR_Target);
    Telemetry.setValue("drivetrain/BL/Azimuth/Target", BL_Target);
    Telemetry.setValue("drivetrain/BR/Azimuth/Target", BR_Target);
    Telemetry.setValue("drivetrain/FL/Drive/Power", FL_Power);
    Telemetry.setValue("drivetrain/FR/Drive/Power", FR_Power);
    Telemetry.setValue("drivetrain/BL/Drive/Power", BL_Power);
    Telemetry.setValue("drivetrain/BR/Drive/Power", BR_Power);
    Telemetry.setValue("drivetrain/FL/Azimuth/Actual_Position", FL_Actual_Position);
    Telemetry.setValue("drivetrain/FR/Azimuth/Actual_Position", FR_Actual_Position);
    Telemetry.setValue("drivetrain/BL/Azimuth/Actual_Position", BL_Actual_Position);
    Telemetry.setValue("drivetrain/BR/Azimuth/Actual_Position", BR_Actual_Position);
    Telemetry.setValue("drivetrain/FL/Drive/Actual_Speed", FL_Actual_Speed);
    Telemetry.setValue("drivetrain/FR/Drive/Actual_Speed", FR_Actual_Speed);
    Telemetry.setValue("drivetrain/BL/Drive/Actual_Speed", BL_Actual_Speed);
    Telemetry.setValue("drivetrain/BR/Drive/Actual_Speed", BR_Actual_Speed);
    Telemetry.setValue("drivetrain/FL/Drive/Temp", FL_Drive.getTemperature());
    Telemetry.setValue("drivetrain/FR/Drive/Temp", FR_Drive.getTemperature());
    Telemetry.setValue("drivetrain/BL/Drive/Temp", BL_Drive.getTemperature());
    Telemetry.setValue("drivetrain/BR/Drive/Temp", BR_Drive.getTemperature());
    Telemetry.setValue("drivetrain/FL/Azimuth/Temp", FL_Azimuth.getTemperature());
    Telemetry.setValue("drivetrain/FR/Azimuth/Temp", FR_Azimuth.getTemperature());
    Telemetry.setValue("drivetrain/BL/Azimuth/Temp", BL_Azimuth.getTemperature());
    Telemetry.setValue("drivetrain/BR/Azimuth/Temp", BR_Azimuth.getTemperature());
    Telemetry.setValue("drivetrain/FL/Azimuth/Bus_Voltage", FL_Azimuth.getBusVoltage());
    Telemetry.setValue("drivetrain/FR/Azimuth/Bus_Voltage", FR_Azimuth.getBusVoltage());
    Telemetry.setValue("drivetrain/BL/Azimuth/Bus_Voltage", BL_Azimuth.getBusVoltage());
    Telemetry.setValue("drivetrain/BR/Azimuth/Bus_Voltage", BR_Azimuth.getBusVoltage());
    Telemetry.setValue("drivetrain/FL/Drive/Bus_Voltage", FL_Drive.getBusVoltage());
    Telemetry.setValue("drivetrain/FR/Drive/Bus_Voltage", FR_Drive.getBusVoltage());
    Telemetry.setValue("drivetrain/BL/Drive/Bus_Voltage", BL_Drive.getBusVoltage());
    Telemetry.setValue("drivetrain/BR/Drive/Bus_Voltage", BR_Drive.getBusVoltage());
    Telemetry.setValue("drivetrain/FL/Azimuth/Output_Voltage", FL_Azimuth.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/FR/Azimuth/Output_Voltage", FR_Azimuth.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/BL/Azimuth/Output_Voltage", BL_Azimuth.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/BR/Azimuth/Output_Voltage", BR_Azimuth.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/FL/Drive/Output_Voltage", FL_Drive.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/FR/Drive/Output_Voltage", FR_Drive.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/BL/Drive/Output_Voltage", BL_Drive.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/BR/Drive/Output_Voltage", BR_Drive.getMotorOutputVoltage());
    Telemetry.setValue("drivetrain/FL/Azimuth/Supply_Current", FL_Azimuth.getSupplyCurrent());
    Telemetry.setValue("drivetrain/FR/Azimuth/Supply_Current", FR_Azimuth.getSupplyCurrent());
    Telemetry.setValue("drivetrain/BL/Azimuth/Supply_Current", BL_Azimuth.getSupplyCurrent());
    Telemetry.setValue("drivetrain/BR/Azimuth/Supply_Current", BR_Azimuth.getSupplyCurrent());
    Telemetry.setValue("drivetrain/FL/Drive/Supply_Current", FL_Drive.getSupplyCurrent());
    Telemetry.setValue("drivetrain/FR/Drive/Supply_Current", FR_Drive.getSupplyCurrent());
    Telemetry.setValue("drivetrain/BL/Drive/Supply_Current", BL_Drive.getSupplyCurrent());
    Telemetry.setValue("drivetrain/BR/Drive/Supply_Current", BR_Drive.getSupplyCurrent());
    Telemetry.setValue("drivetrain/FL/Azimuth/Stator_Current", FL_Azimuth.getStatorCurrent());
    Telemetry.setValue("drivetrain/FR/Azimuth/Stator_Current", FR_Azimuth.getStatorCurrent());
    Telemetry.setValue("drivetrain/BL/Azimuth/Stator_Current", BL_Azimuth.getStatorCurrent());
    Telemetry.setValue("drivetrain/BR/Azimuth/Stator_Current", BR_Azimuth.getStatorCurrent());
    Telemetry.setValue("drivetrain/FL/Drive/Stator_Current", FL_Drive.getStatorCurrent());
    Telemetry.setValue("drivetrain/FR/Drive/Stator_Current", FR_Drive.getStatorCurrent());
    Telemetry.setValue("drivetrain/BL/Drive/Stator_Current", BL_Drive.getStatorCurrent());
    Telemetry.setValue("drivetrain/BR/Drive/Stator_Current", BR_Drive.getStatorCurrent());
